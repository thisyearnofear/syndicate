...
import { useUnifiedWallet, getWalletStatus, WalletTypes } from '@/domains/wallet/services/unifiedWalletService';

export default function WalletDebug() {
  const { isConnected, address, walletType, isConnecting, error, connect } = useUnifiedWallet();
