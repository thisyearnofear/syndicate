...
export function CrossChainTracker({
  ...
  const getStepStatus = (
    ...
    if (status === "linking_wallets") effectiveStatusIndex = 0;
      ...
      effectiveStatusIndex = isCrossChain ? 2 : 1;
    else if (status === "purchasing")
      effectiveStatusIndex = isCrossChain ? 3 : 1;
          ...
          <div className="space-y-1 text-xs">
            <div className="flex items-center justify-between">
              ...
              <span className="text-white font-mono">
                {formatAddress(walletInfo.sourceAddress)}
              </span>
            </div>
                ...
                {stepStatus === "in_progress" && step.estimatedMinutes && (
                  <p className="text-xs text-gray-400 mt-1">
                    ...
                    {step.estimatedMinutes < 1
                      ? "~30 seconds"
                      : `~${step.estimatedMinutes} minute${step.estimatedMinutes > 1 ? "s" : ""}`}
                  </p>
                )}
