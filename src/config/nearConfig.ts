...
// Token Contracts on NEAR
export const NEAR_TOKENS = {
  // USDC wrapped on NEAR from Base (for NEAR Intents 1Click)
  usdcContract: 'base-0x833589fcd6edb6e08f4c7c32d4f71b54bda02913.omft.near',
};
