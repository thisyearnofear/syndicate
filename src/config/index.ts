...
export const CHAINS = {
  base: {
    ...
    pimlicoRpcUrl: process.env.NEXT_PUBLIC_PIMLICO_BASE_RPC || "https://api.pimlico.io/v2/8453/rpc",
  },
  tenderlyFork: {
    id: 8,
  ...
  avalanche: {
    ...
    pimlicoRpcUrl: process.env.NEXT_PUBLIC_PIMLICO_AVALANCHE_RPC || "https://api.pimlico.io/v2/43114/rpc",
  },
  ethereum: {
    ...mainnet,
    name: "Ethereum",
