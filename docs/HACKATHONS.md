...
- **Demo video:** 60s "The Last Seat Wins" kinetic-type reel — real `/season` UI plates, real mainnet stats (2 purchases · 3 tickets · 3 USDC chest), auction to 33.3%, receipt stamps (`0x543995da…09ef5c`, `0xbac9941a…72f4`), settlement reveal. Source, poster, and rendered MP4 live locally under `videos/season-of-tickets-demo/` (the `videos/` directory is git-ignored; video projects are never committed).
